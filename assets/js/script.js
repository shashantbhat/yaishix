...
function updateProgressTimer(videoId, username){
    ...
    //below code is used to get the time meanwhile video's playing
    var timer;
...
//goes to update progress page and update the progessed time there
...
function setStartTime(videoId, username) {
    $.post("ajax/Progress.php", { videoId: videoId, username: username }, function(data) {
        if(isNaN(data)) {
            alert(data);
            return;
        }
